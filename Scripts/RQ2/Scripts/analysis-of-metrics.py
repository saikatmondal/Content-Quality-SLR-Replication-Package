...
# Inputs
# =========================
IN_CSV  = r".../RQ2/RQ2-Quality-Metrics.csv"
OUT_CSV = r".../RQ2/RQ2-Quality-Metrics-Processed.csv"
...
required_cols = {"Study#", "Label_Coding"}
...
for _, row in df.iterrows():
    ...
    label_coding = row["Label_Coding"]

    for methodology, raw_metrics in parse_label_coding(label_coding):
...
out_df = pd.DataFrame(out_rows).sort_values(
    by=["Count", "Metrics"], ascending=[False, True]
